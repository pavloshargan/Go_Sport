...
namespace WpfMaps
{
    ...
    public partial class DragPin : UserControl, INotifyPropertyChanged
    {
        ...
        private Microsoft.Maps.MapControl.WPF.Location _center;
        ...
        public DragPin FirstPin { get; set; }

        public DragPin SecondPin { get; set; }
        ...
        /// </summary> 
        public Action<Microsoft.Maps.MapControl.WPF.Location> Drag;

        /// <summary> 
        /// Occurs when the pushpin starts being dragged. 
        /// </summary> 
        public Action<Microsoft.Maps.MapControl.WPF.Location> DragStart;

        /// <summary> 
        /// Occurs when the pushpin stops being dragged. 
        /// </summary> 
        public Action<Microsoft.Maps.MapControl.WPF.Location, DragPin, DragPin> DragEnd;
